...
For more Details how to install and work with Docker see [INSTALL.md](https://github.com/Digital-Media/fhooe-web-dock/blob/main/INSTALL.md) for Details and Troubleshooting. Replace fhooe-web-dock with the appropriate Docker Repository in githum.com/Digital-Media for other Docker environments.
